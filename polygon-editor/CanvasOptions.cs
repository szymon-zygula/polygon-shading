...
namespace polygon_editor {
    public static class CanvasOptions {
        ...
        public static readonly UInt32 DEFAULT_LIGHT_COLOR = 0xFFFFFFFF;
        public static readonly int LIGHT_ICON_RADIUS = 5;
        public static readonly int LIGHT_ICON_RAYS = 5;
